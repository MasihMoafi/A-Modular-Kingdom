...
This is a brainstormed list of features extracted from OpenClaw and OpenAI's Codex CLI, intended to be integrated into AMK-TUI to evolve it into "Elpis".
...
Codex is written in Rust (like AMK-TUI) and uses a very robust, agent-first terminal interface. Features to copy-paste or implement:
...
## 3. Next Steps for AMK-TUI -> Elpis
